...
//Users should also be able to list all cinemas hall in a city which are displaying a particular movie.
//Also they should be able to fetch list of all shows in a cinema hall which are displaying a particular movie.
//
//Classes implementing last two search features need to updated whenever a new show gets added,
//so that they can update their respective lists.
